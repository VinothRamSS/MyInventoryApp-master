...
public class ProductEditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInputColor = (EditText) findViewById(R.id.edit_product_colour);
        mInputSize = (EditText) findViewById(R.id.edit_product_size);
    ...
    private void saveProduct() {
        ...
        if (mUri == null) {
            Uri uri = Uri.parse("android.resource://com.example.ark.vinothram/drawable/default_image");
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SIZE, sizeString);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String color = cursor.getString(nameColumnIndex);
            int size = cursor.getInt(priceColumnIndex);
            ...
            mInputName.setText(color);
            mInputPrice.setText(Integer.toString(size));
